...
<div id="content">
  ...
  <div class="container-fluid">
	...
	<input type="hidden" name="shipping_apiship_version_js_mod" value="<?php echo $shipping_apiship_version_js_mod; ?>">
	<div>
		...
		<select name="shipping_apiship_sending_country_code" class="form-control">
          ...
          <div class="form-group">
            <label class="col-sm-4 control-label" for="shipping_apiship_package_weight"><?php echo $entry_shipping_apiship_package_weight; ?></label>
            <div class="col-sm-8">
              <input type="number" name="shipping_apiship_package_weight" value="<?php echo $shipping_apiship_package_weight; ?>" placeholder="<?php echo $entry_shipping_apiship_package_weight; ?>" id="shipping_apiship_package_weight" class="form-control" />
            </div>
          </div>
	    ...
	    <?php } ?>
          ...
          <div class="form-group">
			...
			<div class="form-control">
			<?php if (in_array($payment_method['code'],$shipping_apiship_cash_on_delivery_payment_methods)) { ?>
			<label><input type="checkbox" class="form-control" style="float:left" name="shipping_apiship_cash_on_delivery_payment_methods[]" value="<?php echo $payment_method['code']; ?>" checked="checked" /><?php echo $payment_method['name']; ?></label>
			<?php } else { ?>
			<label><input type="checkbox" class="form-control" style="float:left" name="shipping_apiship_cash_on_delivery_payment_methods[]" value="<?php echo $payment_method['code']; ?>" /><?php echo $payment_method['name']; ?></label>
			<?php } ?>
			</div>	
			<?php } ?>
			</div>
